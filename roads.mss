...
@rdz11_maj: 1.6; @rdz11_med: 0.8; @rdz11_min: 0.8;
@rdz12_maj: 2.5; @rdz12_med: 1.8; @rdz12_min: 1.6;
@rdz13_maj: 3;   @rdz13_med: 2.0; @rdz13_min: 2;
@rdz14_maj: 4;   @rdz14_med: 2.5; @rdz14_min: 2.5;
@rdz15_maj: 6;   @rdz15_med: 4;   @rdz15_min: 3;
@rdz16_maj: 10;  @rdz16_med: 9;   @rdz16_min: 4;
@rdz17_maj: 14;  @rdz17_med: 12;  @rdz17_min: 10;
@rdz18_maj: 20;  @rdz18_med: 19;  @rdz18_min: 17;
...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [zoom=11] {
    ...
    [stylegroup='extraroad']  { line-width: 0; }
  ...
  [zoom=15] {
    ...
    [stylegroup='extraroad']{ line-width: @rdz15_min / 3 + 2; }
    [stylegroup='noauto']   { line-width: 0; }
  ...
  [zoom=16] {
    ...
    [stylegroup='extraroad']  { line-width: @rdz16_min * 0.33 + 5; }
    [stylegroup='noauto']   { line-width: 0; }
    [stylegroup='railway']  { line-width: 2 + 2; }
    [type='track']          { line-width: 0;}
  }
  [zoom>=17] {
    ...
    //[stylegroup='extraroad']  { line-width: @rdz17_min * 0.5 + 2; }
    //[stylegroup='noauto']   { line-width: 0; }
  ...
  [zoom>=18] {
    ...
    [stylegroup='minorroad']{ line-width: @rdz18_min * 0.85 + 2; }
    //[stylegroup='extraroad']  { line-width: @rdz18_min * 0.5 + 2; }
    //[stylegroup='noauto']   { line-width: 0; }
  ...
  /*
  Display roads closed in winter
  */
  [winter = 'no'][zoom >= 13]{
    [zoom>=13] { 
      [stylegroup='mainroad'] { winter/line-width: @rdz13_med + 4; }
      [stylegroup='minorroad']{ winter/line-width: @rdz13_min + 4; }
      [stylegroup='extraroad']  { winter/line-width: 0; }
    }
    [zoom>=14] { 
      [stylegroup='mainroad'] { winter/line-width: @rdz14_med + 4; }
      [stylegroup='minorroad']{ winter/line-width: @rdz14_min + 4; }
      [stylegroup='extraroad']  { winter/line-width: @rdz14_min / 3 + 2; }
    }
    [zoom>=15] {
      [stylegroup='mainroad'] { winter/line-width: @rdz15_med + 4; }
      [stylegroup='minorroad']{ winter/line-width: @rdz15_min + 4; }
      [stylegroup='extraroad']  { winter/line-width: @rdz15_min / 3 + 2; }
    }
    [zoom>=16] { 
      [stylegroup='mainroad'] { winter/line-width: @rdz16_med + 4; }
      [stylegroup='minorroad']{ winter/line-width: @rdz16_min + 4; }
      [stylegroup='extraroad']  { winter/line-width: @rdz16_min / 3 + 4; }
    }
    [zoom>=17] {
      [stylegroup='mainroad'] { winter/line-width: @rdz17_med + 7; }
      [stylegroup='minorroad']{ winter/line-width: @rdz17_min + 7; }
      [stylegroup='extraroad']  { winter/line-width: @rdz17_min /3 + 4; }
    }
    [zoom>=18] {
      [stylegroup='mainroad'] { winter/line-width: @rdz18_med + 7; }
      [stylegroup='minorroad']{ winter/line-width: @rdz18_min + 5; }
      [stylegroup='extraroad']  { winter/line-width: @rdz18_min /3 + 5; }
    }
    winter/line-opacity:0.5;
    winter/line-cap:round;
    winter/line-dasharray: 8,30;
    winter/line-color:red;
    [tunnel=1]{line-opacity:0.1;}
  }
}
...
#bridge[render='3_inline'][zoom>=11][zoom<=20]{
  ...
  [stylegroup='railway'] {
    ...
    [zoom>15] { line-dasharray: 10,20; } 
  }
  [stylegroup='noauto'],
  [stylegroup='extraroad'],
  ...
  [type='path']{
    line-color: black;
    [subtype='hiking']{line-color:yellow;}
    
    [subtype='mountain_hiking'],
    [subtype='demanding_mountain_hiking']{line-color:red;}
    
    [subtype='alpine_hiking'],
    [subtype='demanding_alpine_hiking'],
    [subtype='difficult_alpine_hiking']{line-color:yellow;}
  ...
  [zoom=12] {
    ...
    [stylegroup='minorroad']{ line-width: @rdz12_min; }
    [stylegroup='extraroad']  { line-width: @rdz12_min/2;}
    [stylegroup='noauto']   { line-width: 0;}
  ...
  [zoom=13] {
    ...
    [stylegroup='extraroad']  { line-width: @rdz13_min * 0.80;}
  ...
  [zoom=14] {
    ...
    [stylegroup='extraroad']  { line-width: @rdz14_min *0.80;}
  ...
  [zoom=15] {
    ...
    [stylegroup='extraroad']  { line-width: @rdz15_min / 3 + 1.5;}
    [stylegroup='noauto']   { line-width: @rdz15_min / 5;}
  ...
  [zoom=16] {
    ...
    [stylegroup='extraroad']{ line-width: @rdz16_min * 0.33;}
    [stylegroup='noauto']   { line-width: @rdz16_min / 3;}
    [stylegroup='railway']  { line-width: 4; }
    [type='track']          { line-width: @rdz16_min * 0.2;}
  }
  [zoom=17] {
    ...
    [stylegroup='extraroad']  { line-width: @rdz17_min * 0.85;}
    [stylegroup='noauto']   { line-width: @rdz17_min * 0.4;}
    [stylegroup='railway']  { line-width: 5; }
    [type='track']          { line-width: @rdz17_min * 0.6;}
  }
  [zoom>=18] {
    ...
    [stylegroup='extraroad']{ line-width: @rdz18_min * 0.85;}
    [stylegroup='noauto']   { line-width: @rdz18_min * 0.4;}
    [stylegroup='railway']  { line-width: 6; }
    [type='track']          { line-width: @rdz18_min * 0.5;}
  }
}
